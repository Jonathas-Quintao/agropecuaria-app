    ...
    <div className="teste">
      <NavBar />
        ...
        <div>
           ...
           onChange={(selectedOption) => setQuantidadeSelecionada(selectedOption.value)}/>
           {console.log(quantidadeSelecionada)}
           <div className="mt-3"> {/* Adiciona uma margem top */}
          <button type="button" className="btn btn-primary mr-2 rounded" onClick={() => navigation(`/carrinho`,  { state: { produto: produto, quantidade: quantidadeSelecionada } })}>Comprar</button>
